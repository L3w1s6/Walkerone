...
export default function Badge({ emoji, name, unlocked, description, progress }) {
    ...
    return (
        <>
            <div onClick={() => setShowDetails(true)} className="w-full rounded-xl border border-gray-200 bg-white p-2 text-center shadow-sm cursor-pointer select-none hover:scale-110 hover:border-gray-300 transition-all">
